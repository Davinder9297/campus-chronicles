            ...
            <div className='flex '>
                ...
                <div className="flex-col xsm:my-auto">
                    <div className="animation ml-52 xsm:ml-0 xsm:text-smxsm:text-sm">
                        <div className="text-2xl pt-3 xsm:text-sm text-red-600 font-bold "><div className="first ">CAMPUS CHRONICLES</div></div>
                        <div className="text-2xl font-bold xsm:text-sm  text-yellow-300 "><div className="second"></div>CAMPUS CHRONICLES</div>
                        <div className="text-2xl mt-5 pt-2 xsm:text-sm text-blue-600 font-bold "><div className="first">CAMPUS CHRONICLES</div>
                        </div>
                    </div>
