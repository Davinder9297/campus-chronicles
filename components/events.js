    ...
    return (<>
        <div className="flex-col mt-8 mb-5 " id="events" >
            ...
            <div className="flex flex-wrap w-full h-auto justify-between mt-4 max-w-[1250px] ">
                <div className="flex-col h-[420px] border-2 w-[350px] shadow-xl rounded-lg mb-5  hover:scale-90 transition duration-300 ease-in">
                ...
                <div className="flex-col h-[420px] border-2 w-[350px] shadow-xl rounded-lg mb-5 ">
                    <div className=""><img className="rounded-t w-[350px] h-52" src="e1.jpg" alt="" /></div>
                    <div className="flex justify-between">
                        <div className="bg-yellow-500 px-1 mt-1 text-xs py-[1px] rounded-tr rounded-br text-white">Teacher's day</div>
                        <div className="bg-amber-900 mt-1 text-xs px-1 py-[1px] rounded-tl rounded-bl text-white">{s}</div>
