...
export default function Sports() {
    ...
    return (<>
        ...
        <div className=" w-full">
            <div className=" h-36 flex justify-around w-[100%]  shadow-md shadow-green-500 items-center xsm:block bg-slate-50">
                <div className="xsm:w-[100%] xsm:flex xsm:justify-center w-[15%] " >
                    <img className="xsm:h-20 w-full h-36 xsm:w-auto" src="/sports_tile.png" />
                    </div>
                    <div className="flex justify-center w-[70%] xsm:w-[100%]">
                    <img className="h-36 w-[70%] xsm:h-16 xsm:w-[80%] " src="/sports_tile1.png" />
                    </div>
            ...
            <div className="w-[95%] mx-auto">
                ...
                <div className="  text-center font-bold text-3xl mt-2 font-sans p-2 xsm:text-2xl">
                    About us....
                    <div className="mx-3 font-normal text-lg shadow-md shadow-green-500 rounded-xl p-2 text-justify  xsm:text-sm">
            ...
            <div className="flex justify-around w-full xsm:block" >
                ...
                <div className="w-[40%] text-center font-bold text-3xl font-sans mt-3 p-2 xsm:w-[90%] xsm:mx-auto xsm:text-2xl">
                    Our Handlers
                    <div className="shadow-md shadow-green-500 text-2xl m-3 p-3 rounded-xl  xsm:text-xl ">
                        <div className="bg-green-300 rounded-xl">Incharge</div>
                    ...
                    <div className="shadow-md shadow-green-500 text-2xl m-3 p-3 rounded-xl  xsm:text-xl ">
                        <div className="bg-green-300 rounded-xl">President</div>
                ...
                <div className="flex-col='true' w-[50%]  xsm:w-[90%] xsm:mx-auto">
                    ...
                    <div className=" text-center font-bold text-3xl font-sans mt-3 p-2 mx-auto xsm:text-2xl">
                        ...
                        Leading Roles
                        <div className="shadow-md shadow-green-500 text-2xl p-1 rounded-xl space-y-3">
                            <div className="flex flex-row justify-around  mt-3 bg-green-300 rounded-xl">
                            ...
                            {leadingrole.map((dat, index) => {
                                ...
                                return (<>
                                    <div className="flex flex-row justify-around hover:bg-green-100 mt-2 ">
                        ...
                        <div className="flex flex-row justify-around hover:bg-green-100  ">
                            <div className="w-[20%] text-xl h-[58] p-1">
                                2.
                            </div>
                            <div className=" w-[55%] text-xl h-[58] text-left p-1">
            ...
            <div className="flex-col mt-1 mb-5 shadow-md shadow-green-500 w-[95%] mx-auto" id="events" >
