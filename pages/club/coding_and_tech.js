...
export default function Coding() {
    ...
    return (<>
        ...
        <div className=" w-full">
            <div className=" h-auto flex justify-around w-[100%]  shadow-md shadow-purple-500 items-center xsm:block bg-black">
                <div className="xsm:w-[100%] xsm:flex xsm:justify-center w-[13%] " >
                    <img className="xsm:h-20 w-full h-36 xsm:w-auto" src="/coding_anim.gif" />
                    </div>
                    <div className="flex justify-center w-[70%] xsm:w-[100%] font-sans text-white italic xsm:text-3xl text-center text-7xl">
            ...
            <div className="w-[95%] mx-auto">
                ...
                <div className="  text-center font-bold text-3xl mt-2 font-sans p-2 xsm:text-2xl">
                    About us....
                    <div className="mx-3 font-normal text-lg shadow-md shadow-purple-500 rounded-xl p-2 text-justify  xsm:text-sm">
            ...
            <div className="flex justify-around w-full xsm:block" >
                ...
                <div className="w-[40%] text-center font-bold text-3xl font-sans mt-3 p-2 xsm:w-[90%] xsm:mx-auto xsm:text-2xl">
                    Our Handlers
                    <div className="shadow-md shadow-purple-500 text-2xl m-3 p-3 rounded-xl  xsm:text-xl ">
                ...
                <div className="flex-col='true' w-[50%]  xsm:w-[90%] xsm:mx-auto">
                    ...
                    <div className=" text-center font-bold text-3xl font-sans mt-3 p-2 mx-auto xsm:text-2xl">
                        ...
                        Leading Roles
                        <div className="shadow-md shadow-purple-500 text-2xl p-1 rounded-xl space-y-3">
                            ...
                            return (<>
                                <div className="flex-col h-[420px] border-2 w-[350px] shadow-md rounded-lg mb-5 hover:scale-105 transition duration-200 ease-in">
                                    ...
                                    <div className="flex justify-between">
                                        <div className="bg-yellow-400 px-1 mt-1 text-xs py-[1px] rounded-tr rounded-br text-white">{eventname}</div>
