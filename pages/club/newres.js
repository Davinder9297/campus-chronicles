        ...
        <div className="flex justify-between w-full ">
            <div className=" flex-col-reverse flex-wrap  w-[24%] mr-1 ">
                <div className="border-solid border-2 m-3 border-pink-600 h-[160px] rounded-xl shadow-md shadow-pink-400 cursor-pointer hover:scale-105 transition duration-150">
                    <button onClick={()=>(opennext('/club/cultural',"Cultural Club"))} >
                        <img className="rounded-xl h-[158px] object-fill" src="/cultural_logo.png" />
                        {/* <i/> */}
                    </button>
                </div>
                <div className="border-solid border-2 m-3 border-pink-600 h-[160px] rounded-xl shadow-md shadow-pink-400 cursor-pointer hover:scale-105 transition duration-150">
            ...
            direction="up" height="80%" behaviour="scroll" scrollamount="4"> */}
                ...
                <div className="flex flex-row flex-wrap justify-evenly mt-1">
                    <div className="border-solid border-2 m-2 bg-black border-pink-600 h-[150px] text-center rounded-xl w-[45%] justify-items-center shadow-md shadow-pink-400 cursor-pointer hover:scale-105 transition duration-150">
                    ...
                    <button onClick={()=>(opennext('/club/core_commitee',"Core Committee"))}>
                        <img className="rounded-xl h-[147px] w-full" src="core-committee.png" />
                    </button>
                    </div>
                </div>
            </div>
