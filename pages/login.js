    ...
    return (<>
        <div className='bg-zinc-400 w-full h-screen'>
            ...
            <ToastContainer
                ...
                pauseOnHover
            />
            <div className="  h-[60%] w-[50%] mx-auto   bg-white rounded-lg shadow-xl shadow-amber-800 my-20 xsm:w-[85%]">
                ...
                <div className={`justify-around  h-full  flex ${show} `}>
                    <div className='w-[50%]  flex justify-center items-center xsm:hidden bg-amber-400'>
                        <img src="/login_side.png" alt="" />
                    </div>
                    <div className="flex-col w-[50%] text-white bg-gradient-to-r from-amber-800 via-yellow-600 to-amber-800  rounded-tr-lg rounded-br-lg h-[100%] py-2 px-3  text-xs space-y-1 xsm:w-[100%] xsm:rounded-lg">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="text" value={user} onChange={(e) => { setuser(e.target.value) }} className='outline  outline-1 px-2 rounded-sm py-[6px] w-full text-base text-amber-800 outline-gray-300' placeholder="Enter User Id" />
                            <div className='mt-2   font-semibold text-base'>Password</div>
                            <input type="password" value={password} onChange={(e) => { setpassword(e.target.value) }} className='outline outline-1 rounded-sm py-[6px] px-2 w-full text-base text-amber-800 outline-gray-300' placeholder="Enter Password" />
                            ...
                            <button onClick={authenticate} className='flex bg-yellow-400 text-amber-900 font-semibold w-full justify-center py-[6px] rounded-md mt-4 space-x-1 items-center'><BiLogIn className=' text-lg mt-[2px] text-bluamber-900' /> <div className='flex text-base'> Login</div>
                            </button>
                        </form>
                    </div>
                </div>
