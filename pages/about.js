...
export default function About(){
    ...
    <div className="flex justify-center space-x-20 items-center  ">     
        <div className=" flex justify-center items-center h-[50vh]">
         ...
         <div className="w-[50%]">
            <div className="text-center font-serif text-lg font-semibold">About Campus Chronicals</div>
    ...
    <div className="mt-7 flex justify-center   ">
       <div className=" w-[50%] leading-loose">
            ...
            <div className=" min-w-[40%] text-justify font-serif ">
               <div className="text-center text-lg font-semibold"> Programms Offered</div>
               <div className="flex justify-center"><img className="w-44" src="/hr.png" alt="" /></div>
    ...
    <div>
        <div className="mission flex mt-5 justify-around font-serif" >
            <div className="max-w-[40%] ">
                <div className="text-center font-semibold text-lg">Our Mission</div>
                <div className="flex justify-center"><img className="w-40" src="/hr.png" alt="" /></div>
                <div className="text-justify mt-2 flex"><div>To provide seamless education through the pioneering use of
...
seamless in all facets of life.</div></div>
            </div>
            <div className=" w-[40%] flex justify-center items-center"><img className=" rounded" src="/mission.png" alt="" /></div>
        </div>
        <div></div>
    </div>

   <div className="vision flex mt-5 justify-around font-serif" >
   <div className=" w-[40%] flex justify-center items-center "><img className="  rounded" src="/vision.png" alt="" /></div>

            <div className="max-w-[40%] ">
                <div className="text-center font-semibold text-lg">Our Vision</div>
                <div className="flex justify-center"><img className="w-40" src="/hr.png" alt="" /></div>
                <div className="text-justify mt-2 flex"><div>To be an institution of excellence in the domain of higher technical education that serves as the fountainhead for nurturing the future leaders of technology and techno-innovation responsible for the techno-economic, social, cultural and environmental prosperity of the people of the State of Punjab, the Nation and the World.</div></div>
            </div>
        </div>
        <div></div>
